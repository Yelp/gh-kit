...
- (void)testDeriveWithQueryUnicodeURL {
  ...
  XCTAssertEqualObjects(URLString, [derivedURL description]);
}
...
- (void)testDeriveWithQueryRedirectToEscapedURL {
  ...
  XCTAssertEqualObjects([derivedURL description], @"http://www.yelp.com/redir?url=http%3A%2F%2Fwww.google.com");
}
